...
"
" Modifications for haskell.org Copyright (c) 2006 Don Stewart - http://www.cse.unsw.edu.au/~dons
" 
...
" and pull in Haskell syntax highlighting
syn include @Haskell syntax/haskell.vim
syntax region wikiHaskell matchgroup=htmlTag start="<haskell>" end="</haskell>" skip="<nowiki>.*</nowiki>" contains=@Haskell
